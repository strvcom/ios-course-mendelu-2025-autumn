...
struct NewMapPlaceView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Details") {
                Picker("Architectural style", selection: $placeStyle) {
                ...
                Picker("Location type", selection: $placeType) {
...
#Preview {
    NewMapPlaceView(isViewPresented: .constant(true), viewModel: MapPlacesViewModel())
}
