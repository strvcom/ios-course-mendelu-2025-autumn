...
extension Physics {
    ...
    enum CollisionBitMask {
        ...
        static let player = Physics.CategoryBitMask.base
            | Physics.CategoryBitMask.pipe
            | Physics.CategoryBitMask.sceneBorder
        static let pipe = Physics.CategoryBitMask.player
        static let sceneBorder = Physics.CategoryBitMask.player
    }
}
...
extension Physics {
    ...
    enum ContactTestBitMask {
        ...
        static let player = Physics.CategoryBitMask.base
            | Physics.CategoryBitMask.pipe
            | Physics.CategoryBitMask.hole
        static let hole = Physics.CategoryBitMask.player
    }
}
